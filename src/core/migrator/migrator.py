...
class Migrator(QObject):
    ...
    def migrate(
        ...
        Returns:
            dict[Mod | Tool, Exception]: A dictionary of failed mods and tools.
        """
        ...
        errors: dict[Mod | Tool, Exception] = {}
        ...
        additional_files: list[Path] = src_mod_manager.get_additional_files(src_info)
